...
def init_db() -> None:
    ...
    db.activity_log.create_index("email")
    db.activity_log.create_index("department")
    db.activity_log.create_index("meta.session_id")
    db.activity_log.create_index("meta.document_id")
    db.activity_log.create_index("meta.tool")
    db.activity_log.create_index("meta.query_text")
